...
<style>
    ...
    .err-ring {
        ...
        border: clamp(18px, 3vw, 30px) solid #fbbf24;
        border-radius: 500px;
        position: relative;
        display: flex;
        align-items: center;
...
<div class="err-page">
    ...
    <div class="deco" style="top:8%;left:7%">
        <svg width="38" height="38" viewBox="0 0 24 24"><path d="M12 0l2.5 9.5L24 12l-9.5 2.5L12 24l-2.5-9.5L0 12l9.5-2.5z" fill="#fbbf24" opacity=".65"/></svg>
    </div>
    ...
    <div class="deco" style="top:52%;left:4%">
        <svg width="16" height="16" viewBox="0 0 16 16"><circle cx="8" cy="8" r="8" fill="#fbbf24" opacity=".5"/></svg>
    </div>
    ...
    <main class="err-hero">
        ...
        <div class="err-numrow a1">
            <span class="err-digit">5</span>

            <div class="err-ring">
                <img src="{{ asset('images/logo/logo-title.svg') }}"
                     alt="{{ config('app.name') }}"
                     class="err-logo">
                <div class="err-oops">OOPS!</div>
            </div>
        ...
        <div class="a2" style="max-width:560px;">
            <h1 class="text-3xl md:text-5xl font-extrabold text-gray-900 dark:text-white tracking-tight mb-4" style="letter-spacing:-0.02em;">
                Peningkatan Sistem<br>Sedang Berlangsung
            </h1>
            <p class="text-gray-500 dark:text-gray-400 text-sm md:text-base leading-relaxed max-w-md mx-auto">
                Mohon maaf atas gangguannya. <strong>Unit IT</strong> sedang melakukan pemeliharaan rutin untuk meningkatkan kualitas layanan. Kami akan segera kembali!
            </p>
        </div>
    ...
    <div class="err-bar a3">
        ...
        {{-- Right: reload --}}
        <button type="button" onclick="window.location.reload()" class="pill">
            Muat Ulang
